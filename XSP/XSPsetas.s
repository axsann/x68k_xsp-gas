...
0:	|# OBJ_LOOP:
		...
		cmp.w	%a2,%d0
		bcc.b	3f		|# MAX座標 <= SP_x なら push せず
		cmp.w	%a2,%d1
		bcc.b	3f		|# MAX座標 <= SP_y なら push せず
	...
	1:	|# NEXT_OBJ:
		...
		cmp.w	%a2,%d0
		bcc.b	4f		|# MAX座標 <= SP_x なら push せず
		cmp.w	%a2,%d1
		bcc.b	4f		|# MAX座標 <= SP_y なら push せず
